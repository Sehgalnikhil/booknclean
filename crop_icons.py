...
for i, (x, y, w, h) in enumerate(sorted_boxes):
    if i < len(names):
        # We might want to add a bit of padding around the detected box to get the full card
        pad = 10
        y1 = max(0, y - pad)
        ...
        # The background of the card in the mockup might be light grey or white, 
        # let's just save the crop as it is. We can replace the existing files.
